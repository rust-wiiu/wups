...
impl TryFrom<c_wups::WUPSConfigAPICallbackStatus::Type> for MenuError {
    ...
    fn try_from(value: c_wups::WUPSConfigAPICallbackStatus::Type) -> Result<Self, Self::Error> {
        use c_wups::WUPSConfigAPIStatus::*;

        match value {
            WUPSCONFIG_API_RESULT_SUCCESS => Ok(Self::UNKNOWN(WUPSCONFIG_API_RESULT_SUCCESS)),
            WUPSCONFIG_API_RESULT_INVALID_PLUGIN_IDENTIFIER => Err(Self::INVALID_ARGUMENT),
            WUPSCONFIG_API_RESULT_OUT_OF_MEMORY => Err(Self::OUT_OF_MEMORY),
            WUPSCONFIG_API_RESULT_NOT_FOUND => Err(Self::NOT_FOUND),
            WUPSCONFIG_API_RESULT_MISSING_CALLBACK => Err(Self::MISSING_CALLBACK),
            WUPSCONFIG_API_RESULT_MODULE_NOT_FOUND => Err(Self::MODULE_NOT_FOUND),
            WUPSCONFIG_API_RESULT_MODULE_MISSING_EXPORT => Err(Self::MODULE_MISSING_EXPORT),
            WUPSCONFIG_API_RESULT_UNSUPPORTED_VERSION => Err(Self::UNSUPPORTED_VERSION),
            WUPSCONFIG_API_RESULT_UNSUPPORTED_COMMAND => Err(Self::UNSUPPORTED_COMMAND),
            WUPSCONFIG_API_RESULT_LIB_UNINITIALIZED => Err(Self::LIB_UNINITIALIZED),
